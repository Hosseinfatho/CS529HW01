        ...
        return (
          <>
              ...
              >
                ...
                {instructionsExpanded && (
                  <div>
                    ...
                    <p style={{'fontSize': '10px', 'fontStyle': 'italic', 'marginBottom': '0px'}}>{'This code was written by:'}</p>
                    <p style={{'fontSize': '10px', 'fontStyle': 'italic', 'marginTop': '2px'}}>
                      <a href="https://hosseinfatho.github.io/" target="_blank" rel="noopener noreferrer">
            ...
            <div style={{'height': '49%','width':'99%'}}>
              ...
              <div style={{'height': 'calc(100% - 2em)','width': '100%','maxWidth': 'none','marginLeft':'0%'}}>
                <WhiteHatStats
                  data={gunData}
                  ToolTip={ToolTip}
                  brushedState={brushedState}
